...
const BlightLog = ({navigation}) => {
  var APIURL = `${BASE_URL}/PHP/Blight.php`;
          ...
          {item.data.map((item, index) => (
            <View key={index} style={styles.itemContainer}>
                ...
                <View>
                    ...
                    <Text style={[
                        (getdisease(item.Result) == 1) ? styles.blight : styles.disease,
                        ]} 
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.headerBar}>
            <Text style={styles.txtBar}> LEAF BLIGHT LOGS</Text>
      </View>
        {loading ?(
