...
const BlastLog = ({navigation}) => {
  var APIURL = `${BASE_URL}/PHP/Blast.php`;
            ...
            <View key={index} style={styles.itemContainer}>
                ...
                <View style ={{ flexWrap:'wrap'}}>
                    ...
                    <Text style={styles.txtName}>Result:
                      <Text style={[
                          (getdisease(item.Result) == 1) ? styles.blast : styles.disease,
                          ]} 
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.headerBar}>
            <Text style={styles.txtBar}> LEAF BLAST LOGS</Text>
      </View>
      {loading ?(
